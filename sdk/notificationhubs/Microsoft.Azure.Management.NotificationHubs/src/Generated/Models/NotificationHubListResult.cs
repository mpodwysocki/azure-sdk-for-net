...
namespace Microsoft.Azure.Management.NotificationHubs.Models
{
    ...
    internal partial class NotificationHubListResult
    {
        ...
        {
            Value = new ChangeTrackingList<NotificationHubResource>();
        }
        ...
        internal NotificationHubListResult(IReadOnlyList<NotificationHubResource> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<NotificationHubResource> Value { get; }
