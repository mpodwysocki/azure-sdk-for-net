...
{
    public partial class NamespaceResource : IUtf8JsonSerializable
    {
        ...
        internal static NamespaceResource DeserializeNamespaceResource(JsonElement element)
        {
            ...
            return new NamespaceResource(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), sku.Value, name0.Value, provisioningState.Value, region.Value, metricId.Value, status.Value, Optional.ToNullable(createdAt), Optional.ToNullable(updatedAt), serviceBusEndpoint.Value, subscriptionId.Value, scaleUnit.Value, Optional.ToNullable(enabled), Optional.ToNullable(critical), dataCenter.Value, Optional.ToNullable(namespaceType));
        }
    }
}
