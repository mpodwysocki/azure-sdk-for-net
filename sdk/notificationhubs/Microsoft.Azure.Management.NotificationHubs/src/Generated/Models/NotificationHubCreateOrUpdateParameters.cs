...
namespace Microsoft.Azure.Management.NotificationHubs.Models
{
    ...
    public partial class NotificationHubCreateOrUpdateParameters : Resource
    {
        ...
        internal NotificationHubCreateOrUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, Sku sku, string namePropertiesName, string registrationTtl, IList<SharedAccessAuthorizationRuleProperties> authorizationRules, ApnsCredential apnsCredential, WnsCredential wnsCredential, GcmCredential gcmCredential, MpnsCredential mpnsCredential, AdmCredential admCredential, BaiduCredential baiduCredential) : base(id, name, type, location, tags, sku)
        {
