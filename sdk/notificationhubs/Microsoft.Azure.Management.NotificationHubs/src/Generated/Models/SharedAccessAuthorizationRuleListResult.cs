...
namespace Microsoft.Azure.Management.NotificationHubs.Models
{
    ...
    internal partial class SharedAccessAuthorizationRuleListResult
    {
        ...
        {
            Value = new ChangeTrackingList<SharedAccessAuthorizationRuleResource>();
        }
        ...
        internal SharedAccessAuthorizationRuleListResult(IReadOnlyList<SharedAccessAuthorizationRuleResource> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SharedAccessAuthorizationRuleResource> Value { get; }
