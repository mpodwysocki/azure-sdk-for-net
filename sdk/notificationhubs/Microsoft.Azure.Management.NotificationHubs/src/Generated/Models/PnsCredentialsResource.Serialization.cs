...
namespace Microsoft.Azure.Management.NotificationHubs.Models
{
    public partial class PnsCredentialsResource : IUtf8JsonSerializable
    {
        ...
        internal static PnsCredentialsResource DeserializePnsCredentialsResource(JsonElement element)
        {
            ...
            return new PnsCredentialsResource(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), sku.Value, apnsCredential.Value, wnsCredential.Value, gcmCredential.Value, mpnsCredential.Value, admCredential.Value, baiduCredential.Value);
        }
    }
}
